...
ld.lld -m elf_i386 -T linker.ld -nostdlib -n obj/kernel.o obj/vga.o obj/pit.o obj/keyboard.o obj/mouse.o obj/rtc.o obj/speaker.o obj/print.o obj/rng.o obj/str.o obj/idt.o obj/os.o obj/gui.o obj/cmd.o -o kernel.elf
