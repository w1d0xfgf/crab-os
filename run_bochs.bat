...
clang -target i386-pc -march=i486 -flto -m32 -g0 -I./src/c/headers/ -mgeneral-regs-only -O3 -funified-lto -ffreestanding -mno-sse -mno-avx -mno-mmx -fno-stack-protector -fomit-frame-pointer -fno-pic -mno-red-zone -nostdlib -c -o obj/kbc.o src/c/kbc.c
...
ld.lld --lto-O2 --lto=full --no-gc-sections -m elf_i386 -T linker.ld -o kernel.elf obj/entry.o obj/main.o obj/vga.o obj/idt.o obj/pic.o obj/pit.o obj/print.o obj/cmos.o obj/keyboard.o obj/utils.o obj/pmm.o obj/kbc.o
