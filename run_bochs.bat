...
ld.lld --lto-O2 --lto=full --no-gc-sections -m elf_i386 -T linker.ld -o kernel.elf obj/entry.o obj/main.o obj/vga.o obj/idt.o obj/pic.o obj/pit.o obj/print.o obj/cmos.o obj/keyboard.o obj/utils.o obj/pmm.o obj/kbc.o obj/speaker.o
